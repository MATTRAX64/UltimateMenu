...
{
    [BepInPlugin("com.mattrax.ultimatemenu", "UltimateMenu", "1.6.0")]
    public class Log : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            foreach (var t in Assembly.GetExecutingAssembly().GetTypes().Where(t => t.Namespace == typeof(Log).Namespace && t.IsClass && !t.IsAbstract && typeof(MonoBehaviour).IsAssignableFrom(t) && t != typeof(Log) && t != typeof(GorillaInterface)))
